...
Novum contains three related domain contexts. Read only the context relevant to the behavior being changed; read both when work crosses authentication or authorization and an application boundary.
...
- [Mobile Application](apps/mobile/CONTEXT.md): serves Customers independently of the administration system.
...
- `apps/mobile/**` primarily belongs to Mobile Application.
...
- **Mobile Application and Admin System**: Customers and Admin Users are distinct identities and do not share an application session contract.
